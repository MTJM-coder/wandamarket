    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-8 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <h2 className="mt-6 text-center text-sm font-extrabold text-[#071726]">
            Remplissez rapidement vos Informations pour valider l'invitation
          </h2>
