                          ...
                          {method.providers.map((provider) => (
                            <div
                              ...
                              className={`flex items-center space-x-2 p-3 rounded-lg border cursor-pointer ${
                                provider.id === 'orange' ? 'border-orange-200 bg-orange-50' : 'border-yellow-200 bg-yellow-50'
                              }`}
                            >
              ...
              <div className="bg-gray-50 rounded-xl p-4">
                <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-700">{order.client_telephone}</span>
                  </div>
                  
                  <div className="flex items-start space-x-3">
                    <FiMapPin className="w-5 h-5 text-gray-400 mt-0.5" />
                    <div>
                      <p className="text-gray-700">{order.client_quartier}</p>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-8">
              ...
              <div className="space-y-4 mb-6">
                {order.commande_produits?.map((produit) => (
                  <div key={produit.produit.id} className="flex items-start space-x-4">
              ...
              <div className="border-t border-gray-200 pt-4 space-y-3">
                <div className="flex justify-between text-gray-600">
                  ...
                  <span>{order.montant_total?.toLocaleString()} FCFA</span>
                </div>
                ...
                <div className="flex justify-between text-gray-600">
                  ...
                  <span>
                    {/* {order.frais_livraison === 0 
                      ? 'Gratuit' 
                      : `${order.frais_livraison.toLocaleString()} FCFA`
                    } */}
                    Gratuit
                  </span>
                </div>
                ...
                {order.taxes > 0 && (
                  <div className="flex justify-between text-gray-600">
                    <span>Taxes</span>
                    <span>{order.taxe?.toLocaleString()} FCFA</span>
                  </div>
                )}
              ...
              <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                <div className="flex items-start space-x-2">
                  ...
                  <p className="text-sm text-blue-700">
                    Livraison estimée sous 2-3 jours ouvrables dans la région de {orderData.livraison.ville}.
                  </p>
                </div>
              </div>
            </div>
