...
const NavBar2 = ({ searchTerm, setSearchTerm, filters = {}, setFilters, number, setNumber }) => {
  ...
  {/* Icône Livre */}
  <FiBookOpen
    className="text-2xl text-gray-600 hover:text-orange-500 cursor-pointer m-5"
  />
  ...
  >
    ...
    <div className="flex items-center gap-2 cursor-pointer">
      <div className="relative">
        <FiShoppingCart className="text-2xl text-gray-600 hover:text-orange-500 ml-5 my-5" />
        {number > 0 && (
